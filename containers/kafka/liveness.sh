...
# /opt/kafka/bin/kafka-topics.sh --create --topic readiness-$HOSTNAME --bootstrap-server kafka-2.kafka:9092,kafka-0.kafka:9092,kafka-1.kafka:9092 --partitions 1 --replication-factor 2 || echo "topic exists"
